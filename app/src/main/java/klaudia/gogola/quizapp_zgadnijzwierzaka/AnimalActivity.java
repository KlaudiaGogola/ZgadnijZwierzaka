...
import klaudia.gogola.quizapp_zgadnijzwierzaka.DbHelper.AnimalDbHelper;
...
public class AnimalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList = dbHelper.getAllAnimalQuestions();
    ...
    private void goDone() {
        ...
        Intent intent = new Intent(this, AnimalDone.class);
